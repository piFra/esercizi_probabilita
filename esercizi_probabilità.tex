...
q = 1-p = 0.3
$$
Dove $k_1$ \'e il numero di successi desiderati al primo punto del problema, mentre $k_2$ \'e il numero di successi desiderati al secondo punto del problema. Sostituendo i valori per risolvere il primo punto otteniamo:

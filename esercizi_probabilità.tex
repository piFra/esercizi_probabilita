...
P(A) = probabilit\'a\; di\; estrarre\; una\; pallina\; da\; A\\
P(B) = probabilit\'a\; di\; estrarre\; una\; pallina\; da\; B
\end{align}
So che $P(A)=P(B)=\frac{1}{2}$ poich\'e se ho 2 scatole la probabilit\'a di prendere una pallina da una delle due \'e $\frac{1}{2}$.\\
...
$$
P(X_{2}) = P(X_2 | X_1) \cdot P(A) + P(X_2 | X_3) \cdot P(B) = \frac{4}{6} \cdot \frac{1}{2} + \frac{3}{6} \cdot \frac{1}{2} = \frac{7}{12}
$$
Adesso sostituiamo nella formula e otteniamo:
$$
P(X_{1} | X_{2}) = \frac{\frac{4}{6} \cdot \frac{1}{2}}{\frac{7}{12}} = \frac{7}{12} = 0.5714
$$
%------------------------------------------------
